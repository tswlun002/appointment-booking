...
import capitec.branch.appointment.*;
import capitec.branch.appointment.exeption.TokenExpiredException;
import capitec.branch.appointment.user.app.DeleteUserEvent;
import capitec.branch.appointment.user.app.DeleteUserRequestEvent;
import capitec.branch.appointment.user.app.PasswordResetRequestEvent;
import capitec.branch.appointment.user.app.UserCreatedEvent;
