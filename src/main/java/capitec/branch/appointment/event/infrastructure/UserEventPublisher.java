...
import capitec.branch.appointment.otp.domain.OTPEventProducerService;
import capitec.branch.appointment.user.app.DeleteUserEvent;
import capitec.branch.appointment.user.app.PasswordUpdatedEvent;
import capitec.branch.appointment.user.app.UserVerifiedEvent;
