...
public interface OTPEventProducerServicePort {
    CompletableFuture<Boolean> sendRegistrationEvent(@Username String Username, @CustomerEmail String email,
    ...
    CompletableFuture<Boolean>  sendPasswordResetRequestEvent( @Username String Username, @CustomerEmail String email,
                                          @NotBlank(message = ValidatorMessages.FIRSTNAME+" "+ ValidatorMessages.LASTNAME)
                                          String fullname,
                                          @OTPCode String OTP,
                                          @NotBlank(message = ValidatorMessages.EVENT_TRACE_ID_MESS) String traceId);

    CompletableFuture<Boolean>  deleteUserRequestEvent( @Username String Username, @CustomerEmail String email,
